    ...
    <tr>
      <td style="padding:0;">
        ...
        ">
          ...
          <p style="font-size:14px;line-height:1.75;margin:0 0 18px 0;color:#1f2937;">
            Your account password has been updated successfully. Please find your latest login credentials below.
          </p>
          ...
          ">
            <p style="font-size:13px;line-height:1.7;margin:0;color:#1f2937;">
              For your security, you can change your password only once in a month.
          ...
          <div style="margin-top:20px;text-align:center;">
            ...
            <div style="margin-top:8px;font-size:12px;color:#6b7280;">
              Access your dashboard, reports & account details
            </div>
          </div>
