  ...
  const compactTopSummary = useMemo(
    () => [
      ...
      },
      {
        label: "View",
        value: "Your Account",
        note: "Secure party-scoped dashboard",
      },
    ],
    [filters.from, filters.rangeKey, filters.to],
  );
              ...
              >
                ...
                <div className="mt-5 flex gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex h-11 flex-1 items-center justify-center rounded-2xl bg-violet-600 text-sm font-semibold text-white border border-violet-600"
                  >
                    Apply Filter
                  </button>
                </div>
...
>
  ...
  <BarChart3 className="h-5 w-5" />
      ...
      <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-600 sm:text-[15px]">
              Review your transactions, receipts, payments, outstanding balances and voucher summary in one premium account dashboard.
      </p>
    </div>
  ...
  <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
    <div className="min-w-0">
      ...
      <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
        Your bill-wise and on-account closing position.
      </p>
    </div>
