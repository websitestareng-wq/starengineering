  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        matchPrefix: true,
        children: [
          { title: "Bills Receivable", href: "/user/reports/bill-wise/receivable" },
          { title: "Bills Payable", href: "/user/reports/bill-wise/payable" },
          { title: "Unraised Invoices", href: "/user/reports/bill-wise/unraised" },
          { title: "Unreceived Invoices", href: "/user/reports/bill-wise/unreceived" },
          { title: "On Account", href: "/user/reports/bill-wise/on-account" },
        ],
      },
    ],
  },
...
function isAnyChildActive({
  ...
  return items.some((item) => {
    ...
    return (
      currentActive ||
      (item.children ? isAnyChildActive({ pathname, items: item.children }) : false)
    );
  });
}
